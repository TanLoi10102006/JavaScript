...
// Function Deralition(Hàm khai báo trước r truyền vào)

function sumCallback(acc, cur) {
  return acc + cur;
}

let sumDecl = M2.reduce(sumCallback, 0);

console.log("Declaration:", sumDecl); // 18
